  ...
  return (
    <main className='relative overflow-hidden object-cover'>
         <div className="relative flex justify-center items-center">
              <Spline
        scene="https://prod.spline.design/0HwvNU23WxbLwRkZ/scene.splinecode" 
        className="absolute w-full h-full object-cover"
      />
                <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-lg w-[320px] p-8 mt-10 mb-10 flex flex-col items-center">
